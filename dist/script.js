...
/* harmony import */ var _modules_pictureFrame__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pictureFrame */ "./src/js/modules/pictureFrame.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  ...
  Object(_modules_pictureFrame__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
  ...
  Object(_modules_dragAndDrop__WEBPACK_IMPORTED_MODULE_12__["default"])(); // $("input[name='phone']").mask("+7 (999) 999-99-99");
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(triggerBurger, menuBurger) {
  var btnElem = document.querySelector(triggerBurger),
...
var calc = function calc(size, material, options, promocode, price, state) {
  ...
  var calcFunc = function calcFunc(event, elem, prop) {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getPrice"])('http://localhost:3000/price').then(function (res) {
      return calcFuncWithDB(res);
    }).catch(function (error) {
      return console.log("Fatal ".concat(error));
    });
...
var cards = function cards(trigger, wrapperBlock) {
  var btn = document.querySelector(trigger),
      wrapper = document.querySelector(wrapperBlock); // Обычный способ (без базы данных)
  // styles.forEach(elem => {
...
var dragAndDrop = function dragAndDrop() {
  var uploads = document.querySelectorAll('[name="upload"]'); // Cancelling the default behavior
  ...
  uploads.forEach(function (input) {
    input.addEventListener('drop', function (event) {
      // get files name
      input.files = event.dataTransfer.files; // add image path
      ...
      input.previousElementSibling.textContent = name; // styling the button
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(selector) {
    var cards = wrapper.querySelectorAll(selector); // remove all elements
    ...
    no.classList.remove('animated', 'fadeIn'); // add certain elements on page

    if (cards.length > 0) {
      cards.forEach(function (mark) {
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // Только цифры в инпутах
  ...
  form.forEach(function (elem) {
    elem.addEventListener('submit', function (event) {
      event.preventDefault(); // Create block instead form

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      elem.parentNode.appendChild(statusMessage); // Delete form

      elem.classList.add('animated', 'fadeOutUp');
      setTimeout(function () {
        elem.style.display = 'none';
      }, 400); // Create spinner inside statusMessage block

      var statusImg = document.createElement('img');
      statusImg.setAttribute('src', message.spinner);
      statusImg.classList.add('status', 'animated', 'fadeInUp');
      statusMessage.append(statusImg); // Create textMessage inside statusMessage block
      ...
      var api = elem.closest('.popup-design') || elem.classList.contains('calc_form') ? path.designer : path.question;
...
var mask = function mask(selector) {
  ...
  inputs.forEach(function (input) {
    ...
    input.addEventListener('blur', createMask); // не даем пользователю сместить курсор впарво
...
function modals() {
  ...
  function bindModals(triggerSelector, modalSelector, crossSelector) {
    ...
    var close = document.querySelector(crossSelector);
    ...
    triggerModal.forEach(function (elem) {
  ...
  function openModal(modalSelector, scroll) {
    ...
    modal.style.marginRight = "".concat(scroll, "px");
  ...
  openModalByScroll('.fixed-gift'); // showModalByTime('.popup-consultation', 5000, calcScroll());
}
...
/***/ "./src/js/modules/pictureFrame.js":
/*!****************************************!*\
  !*** ./src/js/modules/pictureFrame.js ***!
  \****************************************/
/*! exports provided: default */
...
var pictureFrame = function pictureFrame(imgSelector) {
  var blocks = document.querySelectorAll(imgSelector);

  var showPicture = function showPicture(block) {
    var img = block.querySelector('img');
    img.src = img.src.slice(0, -4) + '-1.png';
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (elem) {
      elem.style.display = 'none';
    });
  };
...
var scrolling = function scrolling(triggerSelector) {
  var upElem = document.querySelector(triggerSelector);
  var start = false;
  window.addEventListener('scroll', function () {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      if (this.hash !== '') {
        ...
        var widthTop = Math.round(document.body.scrollTop || document.documentElement.scrollTop); // Get hash like this or this.href.match(/#.+/g);

        var hash = this.hash; // Get element to scroll and its pixels to border top 

        var toBlock = document.querySelector(hash).getBoundingClientRect().top;
        var _start = null; // start animation
        ...
        var step = function step(time) {
          ...
          var progress = time - _start; // эта переменная отвечает за количество пикселей на которое нам надо пролистать в течение этой анимации
...
var slider = function slider(slides, direction, btnPrev, btnNext) {
  var slideIndex = 1,
      paused;
  ...
  try {
    var prev = document.querySelector(btnPrev),
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postData, getResources, getPrice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fatch: ".concat(url, ", status: ").concat(res.status));
...
var getPrice = function getPrice(url) {
  var res;
  return regeneratorRuntime.async(function getPrice$(_context3) {
    while (1) {
